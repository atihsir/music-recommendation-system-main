...
# Correct path to reach the data folder from inside the notebook folder
df = pd.concat(
    map(pd.read_csv, [
        '../data/meditationandrelaxation1.csv',
        '../data/meditationandrelaxation2.csv',
        '../data/meditationandrelaxation3.csv',
        '../data/meditationandrelaxation4.csv',
        '../data/meditationandrelaxation5.csv'
    ]),
    ignore_index=True
)
